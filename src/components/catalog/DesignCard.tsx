    ...
    return (
        <div className="group floating-card rounded-2xl overflow-hidden flex flex-col h-full">
            ...
            <Link href={`/catalog/${design.slug}`} className="relative aspect-square overflow-hidden block">
                ...
                {design.isTrending && (
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur text-charcoal text-[8px] font-black px-2.5 py-1.5 rounded-full uppercase tracking-widest shadow-sm">
                        🔥 Trending
                    </div>
                )}
            </Link>
